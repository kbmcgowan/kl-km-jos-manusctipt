...
and the connections between these (Bakhtin 1981). The cognitive reality
...
performance of those identities. This observation holds regardless of
talker and listener awareness. This observation remains true even if
what the listener believes about the talker is false; a monolingual
American listener might expect a Beijing voice to be non-rhotic (McGowan
2016) or a gay male voice to have a lisp (Mack and Munson 2012b).
...
The concept of control, in perception, is less intuitive, but it is
...
recognition have used perception to describe a kind of low-level,
...
sociolinguists to operate{[}\^{}1 {]}(Labov et al. 2011). Importantly
for the present study, this higher, evaluative level of perception is
also the level for which the Matched Guise Technique (MGT) was
originally developed.

In their foundational use of the MGT, for example, Lambert et al. (1960)
found that four bilingual Montrealer's voices evoked quite different
social evaluations in their French vs their English guises. Using the
same talkers in both guises allowed researchers to control for
...
each variety (see also Campbell-Kibler, this volume; Clopper and Pisoni
...
the reason that (Babel, this volume) describes perception as a
``complex, multi-layered process''. The picture that is emerging is one
of simultaneous, layered complexity in the interactive process of social
...
their own experiences with social meanings, and their context-driven
expectations about the voice they are likely to hear, the words that
voice is likely to produce, and the socioindexical properties that voice
is likely to embody. And rather than the outcome of perception (broadly
construed) being a simple lexical item, a set of speech segments, a
single attitude, or a summary evaluative judgment, the listeners
subjective experience appears to be a rich, potentially contradictory,
superposition of all of these and more.

Researchers looking to gain insight into these qualia and how they are
formed need to try to understand \ldots{} something

\subsubsection{Matched Guise: Perception, Evaluation, and
Awareness}\label{matched-guise-perception-evaluation-and-awareness}
...
language attitudes (Hadodo this volume; Chan 2021).
...
(McGowan 2015) or simply `identification' (Drager 2013). The task has
been adopted from its original context of bilingual evaluations but
...
of voice to social type is available to participants' introspective
awareness and therefore requires that listeners not become aware of the
guise manipulation.

However, the majority of studies cannot speak to this lack of awareness
...
\textless!-- XXXXX this goes in the conclusion now I think --kevin
