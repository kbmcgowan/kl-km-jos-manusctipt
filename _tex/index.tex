...
judgment of talkers and voices (cf. Evans 2008, `type 2' processing).
...
different tasks. However, Whalen (1984) finds that listeners judgments
...
slow listener judgments was not supported. This finding is inconsistent
with a model of perception in which socioindexical variation and
coarticulatory information are processed identically given that
coarticulatory mismatches \emph{do} slow listener judgments (Whalen
1984). It is possible that these sources of information are processed
via different systems or, alternatively, that this difference merely
