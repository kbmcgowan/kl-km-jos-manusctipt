...
What the current study can resolve is that the influence of listeners' social knowledge
of speech on perception is not delicate. The present result is equally inconsistent
with a model that disregards social knowledge entirely and with a
