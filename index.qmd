...
information [@babelCampbell-kiblerMcGowanVolume], one can come away from a detailed, rigorous review of the
...
and a gender-protypical 'male' and 'female' face (bottom)](images/facesanddrawings.jpg){width=80%}
...
continuum steps and purported gender presented by the face.](images/Scurve.png){width=80%}
...
stimulus talker.](images/ambiguous-by-rime-step.png){width=80%}
...
plotted with 95% confidence intervals.](images/coefs_instruction.png){width=80%}
...
models plotted with 95% confidence intervals.](images/coefs-logRT_instructions.png){width=80%}
