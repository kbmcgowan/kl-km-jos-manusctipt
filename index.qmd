...
information [@babelCampbell-KiblerMcGowanThis], one can come away from a detailed, rigorous review of the
...
[^1]: We are choosing the words 'congruous' and 'incongruous'
    [@schulman1974] intentionally to suggest faces and voices may pattern together in particular ways in listeners' experience and perception with no implied claim that voices may 'match' or 'mismatch' in some way that suggests either experimenters or participants have veridical access to an objective reality 
...
change their speech style \citep[e.g.][]{wright2023}, these stimuli were produced by one female and one male talker who were
...
reference="fig:scurve"} presents listeners' percepts on this 2AFC task.
...
ambiguous. Darker lines in Figure
[\[fig:scurve\]](#fig:scurve){reference-type="ref"
reference="fig:scurve"} present trials using the female Face; lighter
...
portion of the guise. From Figure
[\[fig:scurve\]](#fig:scurve){reference-type="ref"
reference="fig:scurve"} it would appear that listeners' reported
...
ambiguous. Figure [\[fig:rimes\]](#fig:rimes){reference-type="ref"
reference="fig:rimes"} suggests that this prediction is at least
partially borne out. Figure
[\[fig:rimes\]](#fig:rimes){reference-type="ref" reference="fig:rimes"}
plots proportion 'sack' responses to the ambiguous portion of the
...
line in figure [\[fig:rimes\]](#fig:rimes){reference-type="ref"
reference="fig:rimes"} suggest that the ambiguous fricatives remained
...
at Onset continuum steps 3 & 4 in figure
[\[fig:scurve\]](#fig:scurve){reference-type="ref"
reference="fig:scurve"}. It is not clear from Figure
[\[fig:rimes\]](#fig:rimes){reference-type="ref" reference="fig:rimes"}
...
Indeed, a striking feature of figures
[\[fig:scurve\]](#fig:scurve){reference-type="ref"
reference="fig:scurve"} and
[\[fig:rimes\]](#fig:rimes){reference-type="ref" reference="fig:rimes"}
is how the apparent influence of gender information flips between
congruous and incongruous conditions in the former but remains
essentially constant in the latter. Taken together, these plots suggest
that cues to gender in F0 is a stronger predictor of listeners' reported
percept in this matched guise task than just the purported gender of the
face.
...
together in Figure [\[fig:coefs\]](#fig:coefs){reference-type="ref"
reference="fig:coefs"}. Terms plotted to the left of the dashed zero
line have a negative influence on 'sack' percepts in the model while
terms plotted to the right have a positive influence. As a consistency
check we can observe that the levels of the Onset continuum behave in
precisely the expected ways and all levels are statistically significant
predictors of percept in both models. Onset step 1 (\[ʃ\]) is negatively
associated with 'sack' responses and significant in both the Congruous
($β=-5.00, SE=0.28, p < 0.001$) and Incongruous
($β=-4.84, SE=0.24, p < 0.001$) models. Onset step 5 (\[s\]) is
positively associated with 'sack' responses and significant in both the
Congruous ($β=4.35, SE=, p < 0.001$) and Incongruous
...
incongruous condition. As is visible in the bottom row of Figure
[\[fig:scurve\]](#fig:scurve){reference-type="ref"
reference="fig:scurve"}, the effect of Face on 'sack' responses is not
...
analysis. As can be observed in Figure
[\[fig:coefs\]](#fig:coefs){reference-type="ref" reference="fig:coefs"},
...
In the \[ʃ\]-like portion of the continuum, the interaction with face is
positively associated with 'sack' responses at step 1
($β=0.65, SE=0.28, p < 0.05$) and 2 ($β=0.44, SE=0.18, p < 0.05$). The
interaction of guise with the most ambiguous onset step is not
...
with 'sack' responses and statistically significant
($β=-0.43, SE=0.12, p < 0.001$). Instruction x Onset step4 is also
negatively associated with 'sack' responses but does not reach
significance at the standard alpha level
...
negatively associated with 'sack' responses at step 5
...
plotted in Figure
[\[fig:coefs:logRT\]](#fig:coefs:logRT){reference-type="ref"
reference="fig:coefs:logRT"}. Terms plotted to the left of the zero line
...
($β=0.07, SE=0.007, p < 0.001$ ) models. The same is true of step 4 in
...
significant in both models (see Figure
[\[fig:coefs:logRT\]](#fig:coefs:logRT){reference-type="ref"
reference="fig:coefs:logRT"}).
...
These crossing patterns can be seen in Figure
[\[fig:coefs:logRT\]](#fig:coefs:logRT){reference-type="ref"
reference="fig:coefs:logRT"}.
